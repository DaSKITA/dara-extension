<template>
  ...
  >
    <div
      class="px-6 py-4 hoverable flex items-center transition select-none"
    ...
    >
      <span
        class="relative cursor-pointer rounded-full bg-red-400 flex items-center justify-center mr-2"
      ...
      <p class="font-semibold ml-3">Aufname</p>
